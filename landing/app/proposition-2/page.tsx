      ...
      <div className="max-w-5xl mx-auto">
        <div className="bg-gray-100 rounded-2xl sm:rounded-3xl p-1">
          <div className="bg-gray-900 rounded-[14px] sm:rounded-[20px] overflow-hidden">
            <div className="flex">
              {/* Sidebar — mobile: bottom bar style, desktop: sidebar */}
...
export default function Proposition2() {
  return (
    <div className="min-h-screen bg-white">
      <Link href="/" className="fixed top-4 right-4 z-50 bg-white/80 backdrop-blur text-xs font-medium text-gray-500 px-3 py-1.5 rounded-full border border-gray-200 hover:border-gray-400 transition-colors">
